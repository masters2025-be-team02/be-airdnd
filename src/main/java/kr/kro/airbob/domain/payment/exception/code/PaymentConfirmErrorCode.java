...
public enum PaymentConfirmErrorCode implements TossErrorCode{
	...
	// custom
	PAYMENT_CONFIRM_ERROR_MISMATCH_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "내부 시스템 처리 작업이 실패했습니다. 관리자에게 문의해주세요.");


	private final HttpStatus statusCode;
	private final String errorCode;

	public static PaymentConfirmErrorCode fromErrorCode(String errorCode) {
